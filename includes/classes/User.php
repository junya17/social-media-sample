...
class User{
    ...
    public function getProfilePic() {
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT profile_pic, last_name FROM users WHERE username='$username'");
		$row = mysqli_fetch_array($query);
    ...
    public function getFriendArray() {
		$username = $this->user['username'];
		$query = mysqli_query($this->con, "SELECT friend_array, last_name FROM users WHERE username='$username'");
		$row = mysqli_fetch_array($query);
    ...
    public function getMultiFriends($user_to_check) {
        $mutualFriends = 0;
