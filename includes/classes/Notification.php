...
class Notification {
   ...
   public function getUnreadNumber() {
    ...
    public function getNotification(){
		...
		$query = mysqli_query($this->con, "SELECT user_to, user_from FROM notifications WHERE user_to='$userLoggedIn' ORDER BY id DESC");
        ...
        if($count > $limit)
            $return_string .= "<input type='hidden' class='nextPageDropdownData' value='" . ($page + 1) . "'><input type='hidden' class='noMoreDropdownData' value='false'>";
             ...
             $return_string .= "<input type='hidden' class='nextPageDropDownData' value='true'><p style='text-align: center;'>No more notification to load</p>";
